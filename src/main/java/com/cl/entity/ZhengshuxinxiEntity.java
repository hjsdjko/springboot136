...
public class ZhengshuxinxiEntity<T> implements Serializable {
	...
	private String zhengshuzhuangtai;
	 ...
	 * 设置：证书状态
	 */
	public void setZhengshuzhuangtai(String zhengshuzhuangtai) {
		this.zhengshuzhuangtai = zhengshuzhuangtai;
	}
	/**
	 * 获取：证书状态
	 */
	public String getZhengshuzhuangtai() {
		return zhengshuzhuangtai;
	}
	/**
	 * 设置：账号
	 */
